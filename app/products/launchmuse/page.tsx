    ...
    <div className="container space-y-12 py-10">
      ...
      <section className="space-y-4">
        ...
        <p className="text-brand-slate/80">
          LaunchMuse is an AI-native tool that helps artists, managers, and
          small labels plan six-week release campaigns for singles, EPs, and
          albums. It&apos;s designed to answer a simple question:
        </p>
        <blockquote className="border-l-4 border-brand-teal/40 pl-4 text-brand-slate/80 italic">
          &quot;How can tell my story more effectively than just saying to check
          out my release?&quot;
        </blockquote>
        <p className="text-brand-slate/80">
          As a product manager with firsthand creator context, I wanted to
          validate a core hypothesis:
        </p>
        <blockquote className="border-l-4 border-brand-teal/40 pl-4 text-brand-slate/80 italic">
          &quot;A focused, AI-powered MVP can generate a complete six-week
          campaign around a release date, so artists can spend more time making
          music and less time building spreadsheets.&quot;
        </blockquote>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-brand-slate/80">
          For most independent artists and small teams, a release campaign
          means:
        </p>
        <ul className="list-disc space-y-2 pl-6 text-brand-slate/80">
          <li>
            Building a calendar from scratch for 4&ndash;6 weeks of content.
          </li>
          <li>
            Deciding what to post on each channel (Instagram, TikTok, YouTube,
            email, etc.).
          </li>
          <li>
            Remembering key milestones (pre-saves, teasers, behind-the-scenes,
            launch day, follow-up).
          </li>
          <li>
            Translating the story behind the music into consistent,
            audience-ready content.
          </li>
        </ul>
        <p className="text-brand-slate/80">
          The result: a lot of creative energy is spent on logistics instead of
          the art itself.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc space-y-2 pl-6 text-brand-slate/80">
          ...
          <li>
            Implemented an AI-powered campaign generator driven by structured
            prompts.
          </li>
          <li>
            Wired it into a simple UI where artists can input their release
            details.
          </li>
          <li>Deployed a live, working MVP that real artists can try.</li>
        </ul>
        <p className="text-brand-slate/80">
          Total time from blank repo to working prototype:{" "}
          <strong>~10 hours</strong>.
        </p>
        <p className="text-brand-slate/80">
          This wasn&apos;t a slide deck or a static mockup&mdash;it was a
          functioning AI-native MVP built specifically to test whether the core
          value proposition resonated with real users.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-brand-slate/80">
          Today&apos;s LaunchMuse MVP focuses on a single, high-leverage
          feature: a <strong>six-week release campaign generator</strong>.
        </p>
        <p className="text-brand-slate/80">Given a release, it can:</p>
        <ul className="list-disc space-y-2 pl-6 text-brand-slate/80">
          <li>
            <strong>Generate a structured six-week plan</strong> around your
            release date, including pre-launch, launch week, and post-launch
            follow-up.
          </li>
          <li>
            <strong>Propose post ideas and themes per channel</strong> (e.g.,
            Instagram, TikTok, YouTube, email newsletter) that you can adapt to
            your voice.
          </li>
          <li>
            <strong>Surface key milestones and reminders</strong>, like pre-save
            pushes, teaser content, story-driven posts, and fan-engagement
            prompts.
          </li>
          <li>
            <strong>Create an iteration loop</strong> so you can regenerate,
            refine, and customize campaigns as you learn what resonates with
            your audience.
          </li>
        </ul>
        <p className="text-brand-slate/80">
          It&apos;s intentionally narrow in scope: one job, done well.
          That&apos;s the point of the MVP&mdash;validate the core value before
      ...
      <section className="space-y-4">
        ...
        <p className="text-brand-slate/80">
          This is not a mockup&mdash;the open alpha is the actual working MVP I
          built with Codes and ChatGPT to test real-world value.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-brand-slate/80">
          LaunchMuse is a personal demonstration of how I approach AI-native
          product development:
        </p>
        <ul className="list-disc space-y-4 pl-6 text-brand-slate/80">
          <li>
            ...
            <br />
            Define a concrete, painful problem for a specific user (independent
            artists and small labels planning releases).
          </li>
          <li>
            <strong>AI-native solution design</strong>
            <br />
            Start from, &quot;What becomes possible if AI is built into the
            workflow from day one?&quot; rather than bolting AI on later.
          </li>
          <li>
            <strong>Rapid, AI-assisted prototyping</strong>
            <br />
            Use Codes and ChatGPT to go from problem statement to working MVP in
            hours&mdash;not months&mdash;while still respecting UX and
            reliability.
          </li>
          <li>
            <strong>Experiment design &amp; validation</strong>
            <br />
            Ship a focused MVP (the six-week campaign generator) and observe: Do
            artists find it useful? Do they adapt the output? Where does it fall
            short?
          </li>
          <li>
            <strong>Full-stack ownership</strong>
            <br />
            Own the experience end-to-end: problem framing, UX, prompt design,
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc space-y-2 pl-6 text-brand-slate/80">
          <li>
            Deeper personalization based on genre, audience size, and artist
            brand.
          </li>
          <li>
            Built-in asset and content tracking, so posts, videos, and stories
            live alongside the campaign plan.
          </li>
          <li>
            Integrations with scheduling tools and analytics, closing the loop
        ...
        <p className="text-brand-slate/80">
          LaunchMuse is my proof that AI doesn&apos;t just help us prototype
          ideas&mdash;it lets us ship working MVPs that validate the core value
          of the products we want to build.
        </p>
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr,1.1fr] lg:items-center">
          ...
          <div className="space-y-4">
            <div className="space-y-3">
              <h2
                id="launchmuse-waitlist"
                className="text-3xl font-semibold text-brand-teal"
              >
                Join the LaunchMuse waitlist
              </h2>
              <p className="text-brand-slate/80">
                Join the early access list. We&apos;ll invite cohorts in waves
                and share progress.
              </p>
            </div>
            <WaitlistForm />
      ...
      <footer className="rounded-3xl border border-brand-slate/10 bg-brand-teal/10 p-6 text-sm text-brand-slate/80">
        LaunchMuse is developed independently by Daniel Nash. Not affiliated
        with any past employer.
      </footer>
    </div>
  );
}
